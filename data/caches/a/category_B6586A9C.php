<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:62:"D:/wwwroot/meishi15/wwwroot/mobile/themes/miqinew/category.dwt";i:1;s:79:"D:/wwwroot/meishi15/wwwroot/mobile/themes/miqinew/library/goods_list_search.lbi";i:2;s:67:"D:/wwwroot/meishi15/wwwroot/mobile/themes/miqinew/library/pages.lbi";i:3;s:73:"D:/wwwroot/meishi15/wwwroot/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1437114910;s:8:"maketime";i:1437111310;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>美素果_美释品牌代理商管理系统 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=147&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=147&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=147&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=147&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <input type="hidden" name="order" value="" />
        ...
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=176&u=3203" > <img src="http://meishi.huo15.com/images/201506/thumb_img/176_thumb_G_1434672480806.jpg" alt="MISS果"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=176&u=3203" >MISS果</a> </div>
            ...
            <a href="goods.php?id=176&u=3203" ></a>
            <div class="proService"> <del>￥<span>0</span></del></div>
            <div class="proSales">月销:<em>0</em></div>
         <!--   <div >
            	 最小拿货量：<em style="color: #ee6a6a;font-size: 16px;font-weight: 700;margin-left: 2px;">9000</em>
            </div> -->
            <div class="proIcons"> 
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=147&page=1">1</option>
                                    </select>
          </div>
  ...
  <p class="link region"> <a href="http://meishi.huo15.com/?computer=1"> 电脑版 </a> <a href="./"> 微信版 </a> <a href="http://host.huo15.com"> 火一五信息科技 </a> <a class="#"> Android客户端 </a> </p>
  <p class="region"> 
     
    &copy; 2005-2015 美释品牌代理商管理系统 版权所有，并保留所有权利。 </p>
  <div class="favLink region"> <a href="http://www.huo15.com"> powered by HUO15 </a> </div>
</div>
...
<div class="global-nav   global-nav--current">
    <div class="global-nav__nav-wrap">
        ...
        <div class="global-nav__nav-item">
            <a href="distribute.php" class="global-nav__nav-link">
                <i class="global-nav__iconfont global-nav__icon-my-yhd">&#xf0005;</i><span class="global-nav__nav-tit">代理中心</span>
            </a>
        </div>
    </div>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="1">美素果</a></li>
                        <input type="hidden" name="brand" value="0" />
          </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=147&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
