...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=146&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=146&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=146&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=146&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=146&page=1">1</option>
                                    </select>
          </div>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="2">AL</a></li>
                        <input type="hidden" name="brand" value="0" />
          </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=146&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
