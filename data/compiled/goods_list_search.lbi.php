        ...
        <div class="pro-inner">
          ...
          <div class="proInfo-wrap">
            ...
            <div class="proPrice"> 
              ...
              <?php else: ?> 
              代理价格<em>￥<?php echo $this->_var['goods']['agent_price']; ?></em>&nbsp;&nbsp;
             
              <?php endif; ?> 
            </div>
            <a href="<?php echo $this->_var['goods']['url']; ?>" ></a>
         ...
         <!--   <div >
            	<?php if ($this->_var['goods']['brand_id'] == 2): ?>品牌混批起价<?php else: ?> 最小拿货量<?php endif; ?>：<em style="color: #ee6a6a;font-size: 16px;font-weight: 700;margin-left: 2px;"><?php echo $this->_var['goods']['min_num']; ?><?php if ($this->_var['goods']['brand_id'] == 2): ?> 元<?php endif; ?></em>
            </div> -->
            <div class="proIcons"> 
