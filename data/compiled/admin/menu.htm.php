...
<li name="menu" key="02_cat_and_goods" class="explode">
    商品管理        <ul style="display: block;">
        ...
        <!-- <li class="menu-item"><a target="main-frame" href="goods_batch.php?act=add">商品批量上传</a></li>
          ...
          <li class="menu-item"><a target="main-frame" href="brand.php?act=list">商品品牌</a></li>
...
<li class="explode" style="display:none" key="menu_2" name="menu">
	促销管理
    <ul>
...
<li class="explode" key="menu_2" name="menu">
	代理商管理
      <ul>
        <li class="menu-item"><a href="users.php?act=list" target="main-frame"><font style="color:red">代理商列表</font></a></li>
        <li class="menu-item"><a href="users.php?act=add" target="main-frame">添加代理商</a></li>
...
<li name="menu" key="02_cat_and_goods" class="explode">
   <font style="color:red"> 分销设置</font>        <ul style="display: block;">
		<li class="menu-item"><a href="affiliate.php?act=list" target="main-frame">代理设置</a></li>
...
<li class="explode" key="menu_2" style="display:none" name="menu">
	模板管理
    <ul>
...
<li class="explode" key="menu_3" name="menu" >
    ...
    <!--  <li class="menu-item"><a href="wxch-ent.php?act=wxconfig" target="main-frame">微信接口</a></li>-->
        ...
        <!--  <li class="menu-item"><a href="wxch-ent.php?act=config" target="main-frame">微信通设置</a></li>
          ...
          <li style="display:none" class="menu-item"><a href="wxch-ent.php?act=bonus" target="main-frame">关注送红包</a></li>
          ...
          <li style="display:none" class="menu-item"><a href="wxch-ent.php?act=point" target="main-frame">积分增加</a></li>
