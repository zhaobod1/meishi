...
?>
  <tr>
    ...
    <td align="right"><?php echo $this->_var['goods']['qty']; ?></td>
    ...
    <?php if ($this->_var['use_storage']): ?>
    <td align="right"><span><?php echo $this->_var['goods']['huo15_goods_number']; ?></span><span style="display:none"><?php echo $this->_var['goods']['goods_number']; ?></span></td>
    <?php endif; ?>
	<td align="center">&nbsp;</td>
    <td align="center">
      ...
      <a href="goods.php?act=no_generate&good_id=<?php echo $this->_var['goods']['goods_id']; ?>"  title="生成产品编号"><img src="images/icon_generate.gif" width="16" height="16" border="0" /></a>
