...
<table width="100%" >
  ...
  <?php $_from = $this->_var['user']['brand_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'user_0_86596400_1436938529');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['user_0_86596400_1436938529']):
?>
  <tr>
    <td class="label">代理品牌:</td>
    <td><input type="text" name="agent_brand<?php echo $this->_var['k']; ?>" size="20" value="<?php echo $this->_var['user_0_86596400_1436938529']['agent_brand']; ?>"/> 代理等级：<input type="text" name="agent_level<?php echo $this->_var['k']; ?>" size="20" value="<?php echo $this->_var['user_0_86596400_1436938529']['agent_level']; ?>"/></td>
  </tr>
  <tr>
   <td class="label">审核状态:</td>
    <td>通过<input name="is_ok<?php echo $this->_var['k']; ?>" type="radio"  <?php if ($this->_var['user_0_86596400_1436938529']['is_ok'] == '1'): ?>checked="checked"<?php else: ?><?php endif; ?>  value="1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未审核<input name="is_ok<?php echo $this->_var['k']; ?>" type="radio"  <?php if ($this->_var['user_0_86596400_1436938529']['is_ok'] == '1'): ?><?php else: ?>checked="checked"<?php endif; ?> value="0" /></td>
  </tr>
 	<?php endforeach; else: ?>
      <tr>
    <td class="label">代理品牌:</td>
    <td><input type="text" name="agent_brand0" size="20" value=""/> 代理等级：<input type="text" name="agent_level0" size="20" value=""/></td>
  </tr>
   <tr>
    <td class="label">代理品牌:</td>
    <td><input type="text" name="agent_brand1" size="20" value=""/> 代理等级：<input type="text" name="agent_level1" size="20" value=""/></td>
  </tr>
  ...
  <tr style="display:none">
    ...
    <td><?php echo $this->_var['user_0_86596400_1436938529']['formated_user_money']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>&account_type=user_money">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
  <tr  style="display:none">
    <td class="label"><?php echo $this->_var['lang']['frozen_money']; ?>:</td>
    <td><?php echo $this->_var['user_0_86596400_1436938529']['formated_frozen_money']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>&account_type=frozen_money">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
  <tr style="display:none">
  ...
  <tr style="display:none">
    ...
    <td><?php echo $this->_var['user_0_86596400_1436938529']['pay_points']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>&account_type=pay_points">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> <br />
  ...
  <tr  style="display:none">
    ...
    <td><input type="text" name="email" maxlength="60" size="40" value="<?php echo $this->_var['user_0_86596400_1436938529']['email']; ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
  </tr>
  ...
  <tr  style="display:none">
    ...
    <td><select name="user_rank">
      ...
      <?php echo $this->html_options(array('options'=>$this->_var['special_ranks'],'selected'=>$this->_var['user_0_86596400_1436938529']['user_rank'])); ?>
    </select></td>
  </tr>
  <tr  style="display:none">
    <td class="label"><?php echo $this->_var['lang']['gender']; ?>:</td>
    <td><?php echo $this->html_radios(array('name'=>'sex','options'=>$this->_var['lang']['sex'],'checked'=>$this->_var['user_0_86596400_1436938529']['sex'])); ?></td>
  </tr>
  <tr  style="display:none">
    <td class="label"><?php echo $this->_var['lang']['birthday']; ?>:</td>
    <td><?php echo $this->html_select_date(array('field_order'=>'YMD','prefix'=>'birthday','time'=>$this->_var['user_0_86596400_1436938529']['birthday'],'start_year'=>'-60','end_year'=>'+1','display_days'=>'true','month_format'=>'%m')); ?></td>
  </tr>
  <tr  style="display:none">
    <td class="label"><?php echo $this->_var['lang']['credit_line']; ?>:</td>
    <td><input name="credit_line" type="text" id="credit_line" value="<?php echo $this->_var['user_0_86596400_1436938529']['credit_line']; ?>" size="10" /></td>
  </tr>
...
?>
  ...
  <?php if ($this->_var['user_0_86596400_1436938529']['parent_id']): ?>
  <tr>
    <td class="label"><?php echo $this->_var['lang']['parent_user']; ?>:</td>
    <td><a href="users.php?act=edit&id=<?php echo $this->_var['user_0_86596400_1436938529']['parent_id']; ?>"><?php echo $this->_var['user_0_86596400_1436938529']['parent_username']; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="users.php?act=remove_parent&id=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>"><?php echo $this->_var['lang']['parent_remove']; ?></a></td>
  </tr>
  <?php endif; ?>
  <?php if ($this->_var['affiliate']['on'] == 1 && $this->_var['affdb']): ?>
  <tr>
    <td class="label"><?php echo $this->_var['lang']['affiliate_user']; ?>:</td>
    <td>[<a href="users.php?act=aff_list&auid=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>"><?php echo $this->_var['lang']['show_affiliate_users']; ?></a>][<a href="affiliate_ck.php?act=list&auid=<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>"><?php echo $this->_var['lang']['show_affiliate_orders']; ?></a>]</td>
  </tr>
  <tr>
    <td></td>
    <td>   
...
?>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      <input type="hidden" name="id" value="<?php echo $this->_var['user_0_86596400_1436938529']['user_id']; ?>" />    </td>
  </tr>
</table>
