...
<script>
$(function () {
	$('.c-btn3').each(function(index, element) {
        if ($(element).text() == '') {
			$(element).text('保存收货地址');
		}
		if ($(element).text() == '删除') {
			//$(element).attr('onclick', "if (confirm('<?php echo $this->_var['lang']['drop_consignee_confirm']; ?>')) location.href='user.php?step=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'");
			//$(element).removeAttr('onlick');
			var start = $(element).attr('onclick');
			start = '"' +start+ '"';
			
			var sStr = start.indexOf('&');
			var str = start.substr(sStr);
			var id = str.match(/[\d]+/);
	...
	//修改action
	$('[name="theForm"]').each(function(index, element) {
        $(element).attr('action', 'user.php');
    });
});
</script>
</head>
...
<?php if ($this->_var['action'] == 'consignee_edit'): ?> 
...
<!--
 ...
 <a href="user.php?act=fenxiao2" class="clearfix"> <span>二级分销</span><i></i> </a>
  ...
  <a href="user.php?act=fenxiao4" class="clearfix"> <span>四级分销</span><i></i> </a>
	...
	-->
	<div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
	 <a  href="distribute.php" class="clearfix"> <span>代理中心</span><i></i> </a>
	</div>
    <div class="padd1"></div>
    <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
	 <a  href="user.php?act=update_user" class="clearfix"> <span>个人信息</span><i></i> </a>
	</div>
    <div class="blank3"></div>
    <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
	 <a  href="user.php?act=consignee_edit" class="clearfix"> <span>管理收货地址</span><i></i> </a>
	</div>
    <div class="blank3"></div>
    <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
	 <a  href="user.php?act=certification" class="clearfix"> <span>授权证书</span><i></i> </a>
	</div>
	  <div class="blank3"></div>
  <div class="list_box padd1 radius10" style="display:none;padding-top:0;padding-bottom:0;"> 
...
<?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <section class="order_box padd1 radius10 single_item">
  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
    <tr align="center"><td bgcolor="#ffffff"><a>二维码推荐</a></td>
</tr>
...
<script>
$(function() {
	$('#xx').append('<?php echo $this->_var['total']['goods_price_formated']; ?>');
});
</script>
</html>
