...
<td  style="width:2.5rem;height: 2.5rem;"><?php if ($this->_var['share_info']['headimgurl'] != ''): ?><img src="<?php echo $this->_var['share_info']['headimgurl']; ?>"  style="width:2.5rem;height: 2.5rem;border-radius: 2.5rem;"> <?php endif; ?></td> <td>     <p style="color:rgb(253, 250, 250)"><?php if ($this->_var['share_info']['headimgurl'] != ''): ?>来自&nbsp; <?php echo $this->_var['share_info']['nickname']; ?>&nbsp;的分享<?php endif; ?></p>
  ...
  <!--
   <p style="color:rgb(253, 250, 250)"><span><?php if ($this->_var['url']): ?>分享商品页面可以获取提成哦<?php else: ?>购买商品并且登陆后可以分享页面获取提成哦<?php endif; ?></span></p>
  -->
   <p style="color:rgb(253, 250, 250)"><span>代理商价格对外要保密，否则将收回代理商资格。</span>
...
<!--甜心修改兼容收藏
  ...
  <ul id="agent_ul">
   <li>
	...
	代理价格：<b class="price">￥<span id="agent_price"><?php echo $this->_var['goods']['agent_price']; ?></span></b>
    </li>
  <!--  <li>
    		
	<?php if ($this->_var['goods']['brand_id'] == 2): ?>混批起价<?php else: ?>最少拿货量<?php endif; ?>：<b class="price"><span><?php echo $this->_var['goods']['min_num']; ?><?php if ($this->_var['goods']['brand_id'] == 2): ?> 元<?php endif; ?></span></b>
    </li>-->
   ...
   <!-- <del><?php echo $this->_var['goods']['market_price']; ?></del> -->
    <?php endif; ?></li> 
    <?php else: ?>
    <li style="display:none"><?php echo $this->_var['lang']['shop_price']; ?><b class="price"><?php echo $this->_var['goods']['shop_price_formated']; ?></b>　<?php if ($this->_var['cfg']['show_marketprice']): ?>
   <!-- <del><?php echo $this->_var['goods']['market_price']; ?></del> -->
    <?php endif; ?></li>
    <?php endif; ?> 
...
?><?php if ($this->_foreach['spec']['iteration'] > 1): ?>/<?php endif; ?><?php echo $this->_var['spec']['name']; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></span><i></i></div>
    ...
    <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
        <ul class="ul1">
          <li style="display:none"><?php echo $this->_var['lang']['amount']; ?>：<font id="ECS_GOODS_AMOUNT" class="price"></font></li>
          <li><?php echo $this->_var['lang']['amount']; ?>：<font id="total_price" class="price">￥0</font></li>
          <li></li>
        </ul>
        <ul class="ul2">
...
?>
        ...
        <ul class="quantity">
          ...
          <div class="items"> <span class="ui-number radius5"> 
            ...
            <button type="button" id="decrease_btn" class="decrease radius5" onclick="changenum(- 1)">-</button>
            ...
            <button type="button" id="increase_btn" class="increase radius5" onclick="changenum(1)">+</button>
            <?php else: ?> 
          ...
          <div id="main">
            ...
            <div id="right">
              ...
              <span> 加入数量： <b id="cartNum"></b></span><!-- <span> 总计金额： <b id="cartPrice"></b></span>-->
               <span style="display:none;"> 总计金额： <b id="cartPrice"></b></span> 
               <span> 总计金额： <b id="cartAgentPrice"></b></span> 
            </div>
          </div>
  ...
  <div class="guarantee" style="display:none;">微信支付商家,正品保证,假一罚三,七天无条件退换货。</div>
</div>
...
<section class="s-detail" style="display:none;">
  <header>
...
<script src="/js/huo15_goods_info_front.js"></script>
</body>
</html>