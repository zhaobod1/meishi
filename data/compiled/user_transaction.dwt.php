...
?> 
        ...
        <tr>
            <td><a href="user.php?act=order_tracking&order_id=<?php echo $this->_var['order']['order_id']; ?>" class="c-btn3">扫码发货</a></td>
        </tr>
        <?php endif; ?>
      </table>
      </section>
...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table" >
        ...
        <tr>
          <td align="right" style="display:none"><?php if ($this->_var['order']['money_paid'] > 0): ?> 
        ...
        <tr>
          <td align="right" style="display:none"><?php echo $this->_var['lang']['order_amount']; ?>: <?php echo $this->_var['order']['formated_order_amount']; ?> 
