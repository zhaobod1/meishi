...
listTable.edit = function(obj, act, id)
{
  ...
  txt.onblur = function(e)
  {
    ...
    {
		var caption = txt.parentNode.parentNode.parentNode.parentNode.parentNode.getElementsByTagName('caption');
		
      res = Ajax.call(listTable.url, "act="+act+"&caption="+caption[0].childNodes[0].innerHTML +"&val=" + encodeURIComponent(Utils.trim(txt.value)) + "&id=" +id, null, "POST", "JSON", false);
